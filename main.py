...
def save_bottleneck_features(img_width, img_height, weights_path, train_data_dir, validation_data_dir):
    ...
    np.save(open('large_files/bottleneck_features_train.npy', 'wb'), bottleneck_features_train)
    ...
    np.save(open('large_files/bottleneck_features_validation.npy', 'wb'), bottleneck_features_validation)
    print('bottleneck features saved to file')


# save_bottleneck_features(width, height, weights_path, train_data_dir, validation_data_dir)  # only for first time

train_data = np.load(open('large_files/bottleneck_features_train.npy', 'rb'))
train_labels = np.array([0] * int(nb_train_samples / 2) + [1] * int(nb_train_samples / 2))
validation_data = np.load(open('large_files/bottleneck_features_validation.npy', 'rb'))
